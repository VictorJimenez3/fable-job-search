...
def enrich() -> int:
    """Bounded ChemE AI enrichment, ordered by user value and evidence."""
    ...
    if pasted:
        print(f"enrich: graded {pasted} pasted JD(s) from the ChemE platform")
    ...
    default_quality_limit = "25" if llm.provider() == "local" else "3"

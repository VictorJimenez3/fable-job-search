...
// JavaScript: the GitHub session is sealed into an httpOnly AES-256-GCM cookie,
// while per-user Google refresh tokens are encrypted in the private account
// registry. Repository writes remain owner-only.
